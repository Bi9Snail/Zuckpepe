...
async function main(){
    console.log("metadata for JuckMeme token");
    const myKeypair = loadWalletKey("zukCFbYJ2bdvQEKLkvUeKX2nnh6ViNudKavvUuvzxtL.json");
    const mint = new web3.PublicKey("4gPWfw6jwo9jdjg8QCenvS7ZjFzMvo1UEjtQNrT8N94C");
    ...
    const ourMetadata = { // TODO change those values!
        name: "ZuckPepe", 
        symbol: "ZuckPepe",
        uri: "https://raw.githubusercontent.com/Bi9Snail/Zuckpepe/main/zuckpepe_metadata.json",
    }
    const onChainData = {
        ...ourMetadata,
        // we don't need that
